...
import { Users, TrendingUp, Award, ArrowRight, CheckCircle, Star, BarChart3, Target, Brain, Zap, Sparkles, Shield, Clock } from 'lucide-react';
const Index = () => {
  const {
    toast
  } = useToast();
  ...
  {/* =================================================================================================================================*/}
                ...
                <div className="relative mb-6">
                  <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?w=400&h=300&fit=crop" alt="Our Working Team" className="w-full h-64 object-cover rounded-2xl shadow-lg" />
      ...
      <section className="bg-gradient-to-br from-white to-purple-50 section-padding">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {whyChooseUs.map((item, index) => <motion.div key={index} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <img src={testimonial.image} alt={testimonial.name} className="w-12 h-12 rounded-full object-cover border-2 border-purple-200" />
                        <div>

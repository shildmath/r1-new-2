  ...
  return (
    <AdminAuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        {/* Main Content */}
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-120px)] overflow-hidden">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
              {/* Dashboard Tab */}
              <TabsContent value="dashboard" className="space-y-8 h-full overflow-y-auto">
                {/* Stats Grid */}
              ...
              {/* Other Tabs */}
              <TabsContent value="contact-submissions" className="h-full overflow-hidden">
                <ContactSubmissions />
              </TabsContent>

              <TabsContent value="strategy-calls" className="h-full overflow-hidden">
                <StrategyCallSubmissions />
              </TabsContent>

              <TabsContent value="services" className="h-full overflow-hidden">
                <ServicesManager />
              </TabsContent>

              <TabsContent value="testimonials" className="h-full overflow-hidden">
                <TestimonialsManager />
              </TabsContent>
